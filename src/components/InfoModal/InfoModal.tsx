          ...
          <div className="form-section">
            ...
            {type === 'project' && data.parentRelease && (
              <div className="form-group">
                ...
                <div className="form-input view-only">{data.data.parentRelease}</div>
              </div>
            )}
            ...
            {type === 'project' && (
              <div className="form-group">
                ...
                <div className="form-input view-only">{data.data.link || 'Не указана'}</div>
              </div>
            )}
            ...
            {type === 'release' && (
              <div className="form-group">
                ...
                <div className="form-input view-only">{data.data.version || 'Не указана'}</div>
              </div>
            )}

            {/* <div className="form-group">
              <label className="form-label form-label-bold">Срок:</label>
              <div className="form-input view-only">{data.data.end_date || 'Не указан'}</div>
            </div> */}
          </div>
